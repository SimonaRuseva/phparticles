        ...
        <div class="row">
            <div class="col-md-8 col-md-offset-2">
                <div class="panel panel-default">
                    ...
                    <form method="post" action="{{url('autors')}}" enctype="multipart/form-data">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="form-control form-group-lg" id="lgFormGroupInput" placeholder="age" name="age">
                            </div>
                        </div>
                        <div class="form-group row">
